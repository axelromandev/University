...
public class UpdateAnimal extends javax.swing.JFrame {
     ...
     * @param location
     */
    public UpdateAnimal(String id, String name, String nameplus, String description, String location) {
        initComponents();
    ...
    public void validateData() {
        ...
        methodsSql
                .update(id, name, nameplus, description, location);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateAnimal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
