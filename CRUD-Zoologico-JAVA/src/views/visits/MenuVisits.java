...
public class MenuVisits extends javax.swing.JFrame {

    VisitsProvider methodsSql = new VisitsProvider();

    /**
     * Creates new form MenuVisits
     */
    public MenuVisits() {
        initComponents();
        this.setTitle("Menu Visitas");
        this.setLocationRelativeTo(null);
        btnUpdate.setVisible(false);
        table.setModel(methodsSql.fetchVisits());
    }
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "FECHA", "HORA", "ESCUELA", "VISITANTES"
            }
        ) {
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        String name = this.table.getValueAt(fila, 3).toString();
    ...
    private void btnUpdateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnUpdateMouseClicked
        ...
        String date = this.table.getValueAt(fila, 1).toString();
        String time = this.table.getValueAt(fila, 2).toString();
        String school = this.table.getValueAt(fila, 3).toString();
        String visits = this.table.getValueAt(fila, 4).toString();
        this.setVisible(false);
        UpdateVisits menu = new UpdateVisits(id, date, time, school, visits);
        menu.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuVisits.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuVisits().setVisible(true);
            }
        });
    }
